...
<head>
    ...
    <meta name="description" content="Synox – Finance & Consulting Site Template.">
    <meta name="keywords" content="Finance & Consulting Bootstrap Site Template">
    <meta name="author" content="XpressBuddy">

    <title>404 – Synox – Finance & Consulting Site Template.</title>
    <link rel="shortcut icon" href="/assets/frontend/assets/images/site_logo/favourite_icon.webp">
    ...
    <!-- Custom - CSS Include -->
    <link rel="stylesheet" type="text/css" href="/assets/frontend/assets/css/style.css">
        ...
        <section class="error_section text-center section_decoration">
            <div class="container">
                <div class="error_image">
                    <img src="/assets/frontend/assets/images/404_error_image.webp" alt="404 Error Image">
                </div>
                ...
                <div class="btns_group pb-0">
                    <a class="btn bg-dark" href="{{ route('frontend::home') }}">
            ...
            <div class="decoration_item shape_dollar_4 wow fadeInUp" data-wow-delay=".2s">
                <img src="/assets/frontend/assets/images/shapes/shape_dollar_4.webp" alt="Shape Dollar">
            </div>
        </section>
        <!-- Error Section - End
        ================================================== -->
