<div>
    <x-mary-header subtitle="Here you can add or edit the details of category." >

        <x-slot:title class="text-4xl">
            {{ checkData($category_id)?'Edit':'New' }} Blog Category
        </x-slot:title>
                ...
                <x-mary-card class="shadow border mb-5">
                    ...
                    <div class="grid lg:grid-cols-4 gap-5 mb-5">
                        <div class="col-span-2">
                            <x-forms.input-label label="Icon"
                                                 description="(Dimension:512 x 512 pixels)"
                            >
                                <x-forms.filepond  wire:model="request.icon"
                                                   folder="images/"
                                                   accept="image/*"
                                />
                            </x-forms.input-label>
            ...
            <div class="col-span-12 lg:col-span-3 relative">
                <div class="sticky top-0 left-0">
                    <x-mary-card class="shadow border">
                        <div class="mb-5">
                            <x-mary-button label="Save Category"
                                           class="btn-primary"
                                           spinner="save"
                                           type="submit"
                            />
                        ...
                        <x-mary-input wire:model="request.position"
                                      label="Position"
                                      type="number"
                                      min="0"
                                      max="5000"
