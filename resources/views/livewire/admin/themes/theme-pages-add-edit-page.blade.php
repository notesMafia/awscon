<div>
    <x-mary-header subtitle="Here you can add or edit the content of page." >

        <x-slot:title class="text-4xl">
            {{ checkData($page_id)?'Edit':'New' }} Page
        </x-slot:title>
    ...
    <form wire:submit.prevent="{{checkData($page_id)?'Save':'Submit'}}">
                        ...
                        <x-forms.input-label label="Permalink:">
                            <div>
                                <div class="flex flex-wrap gap-3">
                                    ...
                                    <span>
                                     {{ BackendHelper::getSlugPrefix('theme-page') }}
                                    </span>
                    ...
                    <div x-data="{open:false}">
                        ...
                        <div>
                            <div>
                                ...
                                <a href="{{ BackendHelper::getSlugPrefix('theme-page') }}{{ $request['slug'] ??'' }}"
                                   class="text-sm"
                                   target="_blank"
                                   style="color: #006621"
                                >{{ BackendHelper::getSlugPrefix('theme-page') }}{{ $request['slug'] ??'' }}</a>
                                <p>
            ...
            <div class="col-span-12 lg:col-span-3 relative">
                <div class="sticky top-0 left-0">
                    <x-mary-card class="shadow border">
                        <div class="mb-5">
                            <x-mary-button label="Save Page"
                                           class="btn-primary"
                                           spinner="{{checkData($page_id)?'Save':'Submit'}}"
                                           type="submit"
                            />
                        </div>
                        <div class="flex mb-5">
