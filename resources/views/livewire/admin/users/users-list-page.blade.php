<div>
    <x-mary-header subtitle="Showing the list of users registered on our website." >
        ...
        <x-slot:actions>
            <x-mary-button icon="o-plus"
                           ...
                           href="{{ route('admin::users.website.add') }}"
                           wire:navigate
            />
        </x-slot:actions>
    </x-mary-header>
    ...
    <x-mary-card class="shadow border">
        ...
        >
            ...
            @scope('cell_name', $user)
              <a href="{{ route('admin::users.website.edit',['user_id'=>encryptId($user->id)]) }}"
                 wire:navigate
              ...
              <div class="flex gap-3">
                  <div>
                      <x-mary-button icon="o-pencil-square"
                                     ...
                                     tooltip="Edit"
                                     href="{{ route('admin::users.website.edit',['user_id'=>encryptId($user->id)]) }}"
                                     wire:navigate
                      />
                  </div>
                  <div x-data="{
