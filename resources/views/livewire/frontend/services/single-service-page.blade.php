    ...
    <section class="service_details_section section_space section_decoration overflow-hidden">
        <div class="container">
            <div class="item_details_image position-relative">
                <img src="/assets/frontend/assets/images/services/service_details_image_1.webp" alt="Project Image">
                ...
                <ul class="process_steps_block unordered_list justify-content-lg-between">
                    <li>
                        <div class="step_block_icon">
                            <img src="/assets/frontend/assets/images/icons/icon_headphone.svg" alt="icon Headphone">
                        </div>
                    ...
                    <li>
                        <div class="step_block_icon">
                            <img src="/assets/frontend/assets/images/icons/icon_bulb.svg" alt="icon Bulb">
                        </div>
                    ...
                    <li>
                        <div class="step_block_icon">
                            <img src="/assets/frontend/assets/images/icons/icon_head.svg" alt="icon Head">
                        </div>
                    ...
                    <li>
                        <div class="step_block_icon">
                            <img src="/assets/frontend/assets/images/icons/icon_chart_4.svg" alt="icon Chart">
                        </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                      ...
                      <span class="iconlist_icon">
                        <img src="/assets/frontend/assets/images/icons/icon_check.svg" alt="icon Check">
                      </span>
        ...
        <div class="decoration_item shape_nate_1 wow fadeInUp">
            <img src="/assets/frontend/assets/images/shapes/shape_nate_3.svg" alt="Shape Nate">
        </div>
        <div class="decoration_item shape_nate_2 wow fadeInUp">
            <img src="/assets/frontend/assets/images/shapes/shape_nate_4.svg" alt="Shape Nate">
        </div>
        <div class="decoration_item shape_nate_3 wow fadeInUp">
            <img src="/assets/frontend/assets/images/shapes/shape_nate_5.svg" alt="Shape Nate">
        </div>
        <div class="decoration_item shape_nate_4 wow fadeInUp">
            <img src="/assets/frontend/assets/images/shapes/shape_nate_6.svg" alt="Shape Nate">
        </div>
    </section>
