...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="/assets/frontend/rev/fonts/pe-icon-7-stroke/css/pe-icon-7-stroke.css">
    <link rel="stylesheet" type="text/css" href="/assets/frontend/rev/fonts/font-awesome/css/font-awesome.css">
    <link rel="stylesheet" type="text/css" href="/assets/frontend/rev/css/rs6.css">
    <!--owl carousel-->
    <link rel="stylesheet" href="/assets/frontend/css/owl.carousel.min.css">
    <!--Circle Slider CSS -->
    <link rel="stylesheet" href="/assets/frontend/css/roundslider.css">
    <!--Progressbar CSS -->
    <link rel="stylesheet" href="/assets/frontend/css/progressbar.css">
    <!-- Animation CSS -->
    <link rel="stylesheet" href="/assets/frontend/css/animations.min.css">
    <!-- Magnefic Popup CSS -->
    <link rel="stylesheet" href="/assets/frontend/css/magnific-popup.min.css">
    <!--icon css -->
    <link rel="stylesheet" href="/assets/frontend/fonts/font-awesome/css/all.min.css">
    ...
    <link rel="stylesheet" href="/assets/frontend/fonts/themify-icons/themify-icons.css">
    <!--style css-->
...
<div id="pq-loading">
    <div id="pq-loading-center">
        <img src="/assets/frontend/images/logos/logo-1.png" alt="loading">
    </div>
</div>
<!--Loading End -->
...
<div class="pq-sidebar">
    ...
    <div class="pq-sidebar-block ">
        <div class="pq-sidebar-header">
            <img src="/assets/frontend/images/logos/logo-1.png" class="pq-sidebar-logo mCS_img_loaded" alt="techtrix-sidebar-logo">
        ...
        <div class="pq-sidebar-contact">
            ...
            <ul class="pq-sidebar-contact">
                ...
                <li>
                    <a href="mailto:peacefulqode@gmail.com"><i class="fa fa-envelope"></i><span>peacefulqode@gmail.com</span></a>
                </li>
            </ul>
        </div>
        ...
        <div class="row no-gutters">
            <div class="col-lg-2 col-md-4">
                <a class="navbar-brand" href="main-home.html">
                    <img class="img-fluid logo" src="/assets/frontend/images/logos/footer-logo.png" alt="techtrix">
                </a>
            </div>
                        ...
                        <div class="row flex-row-reverse">
                            ...
                            <div class="col-md-6 p-0">
                                <div class="pq-header-contact ">
                                    <ul>
                                        <li>
                                            <a href="tel:+180045647824"><i class="fas fa-phone"></i>
                                                <span>+1-800-456-478-24</span>
                                            </a>
                                        </li>
                                        <li>
                                                ...
                                                <li class="menu-item current-menu-item manu-item-has-children">
                                                    ...
                                                    <ul class="sub-menu">
                                                        <li class="menu-item current-menu-item menu-item-has-children">
                                                            <a href="#">Muti Page</a><i class="fa fa-chevron-down pq-submenu-icon"></i>
                                                            <ul class="sub-menu">
                                                                <li class="menu-item">
                                                        ...
                                                        <li class="menu-item menu-item-has-children">
                                                            <a href="#">One Page</a><i class="fa fa-chevron-down pq-submenu-icon"></i>
                                                            <ul class="sub-menu">
                                                                <li class="menu-item">
...
<div class="banner py-0">
    ...
    <rs-module-wrap id="rev_slider_11_1_wrapper" data-alias="home-1-1" data-source="gallery" style="background:transparent;padding:0;margin:0px auto;margin-top:0;margin-bottom:0;">
        <rs-module id="rev_slider_11_1" data-version="6.3.2">
            <rs-slides>
                <rs-slide data-key="rs-36" data-title="Slide" data-thumb="/assets/frontend/rev/assets/bg-6-50x100.jpg" data-anim="ei:d;eo:d;s:600;r:default;t:crossfade;sl:d;">
                    <img src="/assets/frontend/rev/assets/bg-6.jpg" title="bg-6" width="1920" height="1080" class="rev-slidebg" data-no-retina>
                    <!--
                                                --><rs-layer
                    ...
                    >Excellent It Services <br> For Your Success<br>
                    ...
                    >It is a long established fact that a reader will be distracted by<br>
                        the of a page when looking at its layout.
                    </rs-layer><!--
                    ...
                    >Contact Us
                        ...
                        data-frame_999="o:0;st:w;"
                        style="z-index:13;"
                    ><img src="/assets/frontend/rev/assets/img-1.png" width="601" height="715" data-no-retina>
                    </rs-layer><!--
                        ...
                        data-frame_999="o:0;st:w;"
                        style="z-index:14;"
                    ><img src="/assets/frontend/rev/assets/img-arrow.png" width="878" height="220" data-no-retina>
                    </rs-layer><!--
-->						</rs-slide>
                <rs-slide data-key="rs-47" data-title="Slide" data-thumb="/assets/frontend/rev/assets/bg-6-50x100.jpg" data-anim="ei:d;eo:d;s:600;r:default;t:crossfade;sl:d;">
                    <img src="/assets/frontend/rev/assets/bg-6.jpg" title="bg-6" width="1920" height="1080" class="rev-slidebg" data-no-retina>
                    <!--
                                                --><rs-layer
                        ...
                        data-frame_999="o:0;st:w;"
                        style="z-index:10;font-family:Jost;text-transform:capitalize;"
                    >Innovative and<br> Productive Solution
                    </rs-layer><!--
                    ...
                    >Contact Us
                        ...
                        data-frame_999="o:0;st:w;"
                        style="z-index:13;"
                    ><img src="/assets/frontend/rev/assets/img-2.png" width="669" height="900" data-no-retina>
                    </rs-layer><!--
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="pq-section pq-style-1 text-center">
                    ...
                    <h5 class="pq-section-title" id="flexible" data-high_text="Flexible" data-title_text="We Provide Flexible IT Services" data-rough_color="#fd4a18" data-rough_type="underline">We Provide Flexible IT Services</h5>
                </div>
            </div>
            <div class="col-xl-3 col-lg-6 col-md-6">
                <div class="pq-icon-box pq-style-7">
                    ...
                    <div class="pq-icon-box-content">
                        ...
                        <p class="pq-icon-box-description">Lorem ipsum dolor sit amet, consectetur.</p>
                    </div>
                </div>
            </div>
        ...
        <div class="row align-items-center">
            <div class="col-xl-6 col-lg-6">
                <div class="about-us-img">
                    <img src="/assets/frontend/images/about-us/10.jpg" alt="">
                            ...
                            <div class="pq-counter-contain">
                                <div class="pq-counter-info">
                                    <div class="pq-counter-num-prefix">
                                        <h5 class="timer pq-text-primary" data-to="20" data-speed="2000">20</h5>
                                        <span class="pq-counter-prefix pq-text-primary">+</span>
                                    </div>
                                    <p class="pq-counter-description">Years Of<br> Experience</p>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-xl-6 col-lg-6 mt-4 mt-lg-0">
                <div class="pq-section pq-style-1 text-left">
                    ...
                    <h5 class="pq-section-title" id="business" data-high_text="Business" data-title_text="Product Devlopment For Better Business" data-rough_color="#fd4a18" data-rough_type="underline">Product Devlopment For Better Business</h5>
                    <p class="pq-section-description">There are many variations of passages of Lorem Ipsum available, but majority have suffered alteration in some form, by injected humour</p>
                </div>
                <div class="row">
                    <div class="col-lg-6 col-md-6">
                        <div class="pq-fancy-box pq-fancybox-5">
                            <div class="pq-fancy-media">
                                ...
                                <h5 class="pq-fancy-box-title">Qualifid <br>Consultans</h5>
                            </div>
                            <div class="pq-fancybox-info">
                                <p>Lorem Ipsum has been the industry’s<br>text ever since the when.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-6">
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="pq-section pq-style-1 text-center">
                    ...
                    <h5 class="pq-section-title" id="product" data-high_text="Business" data-title_text="Product Devlopment For Better Business" data-rough_color="#fd4a18" data-rough_type="underline">Product Devlopment For Better Business</h5>
                </div>
                    ...
                    <div class="item">
                        <div class="pq-fancybox-boxslider fancyslider-2">
                            ...
                            <div class="pq-btn-container">
                                <div class="pq-button-block">
                                    <a class="pq-button pq-btn-link" href="contact-us.html" target="_blank">
                    ...
                    <div class="owl-carousel owl-loaded owl-drag" data-dots="true" data-nav="false" data-desk_num="4"
                        ...
                        <div class="item">
                            <div class="pq-portfolio-block">
                                <div class="pq-portfolio-img">
                                    <a href="#">
                                        <img src="/assets/frontend/images/portfolio/1.jpg" alt="">
                                    </a>
                                </div>
                        ...
                        <div class="item">
                            <div class="pq-portfolio-block">
                                <div class="pq-portfolio-img">
                                    <a href="#">
                                        <img src="/assets/frontend/images/portfolio/3.jpg" alt="">
                                    </a>
                                </div>
                                <div class="pq-portfolio-info">
                                    <div class="pq-portfolio-link">
                        ...
                        <div class="item">
                            <div class="pq-portfolio-block">
                                <div class="pq-portfolio-img">
                                    <a href="#">
                                        <img src="/assets/frontend/images/portfolio/5.jpg" alt="">
                                    </a>
                                </div>
                                <div class="pq-portfolio-info">
                                    <div class="pq-portfolio-link">
                        ...
                        <div class="item">
                            <div class="pq-portfolio-block">
                                <div class="pq-portfolio-img">
                                    <a href="#">
                                        <img src="/assets/frontend/images/portfolio/6.jpg" alt="">
                                    </a>
                                </div>
                                <div class="pq-portfolio-info">
                                    <div class="pq-portfolio-link">
                        ...
                        <div class="item">
                            <div class="pq-portfolio-block">
                                <div class="pq-portfolio-img">
                                    <a href="#">
                                        <img src="/assets/frontend/images/portfolio/7.jpg" alt="">
                                    </a>
                                </div>
                                <div class="pq-portfolio-info">
                                    <div class="pq-portfolio-link">
                        ...
                        <div class="item">
                            <div class="pq-portfolio-block">
                                <div class="pq-portfolio-img">
                                    <a href="#">
                                        <img src="/assets/frontend/images/portfolio/8.jpg" alt="">
                                    </a>
                                </div>
                                <div class="pq-portfolio-info">
                                    <div class="pq-portfolio-link">
                        ...
                        <div class="item">
                            <div class="pq-portfolio-block">
                                <div class="pq-portfolio-img">
                                    <a href="#">
                                        <img src="/assets/frontend/images/portfolio/9.jpg" alt="">
                                    </a>
                                </div>
                                <div class="pq-portfolio-info">
                                    <div class="pq-portfolio-link">
                        ...
                        <div class="item">
                            <div class="pq-portfolio-block">
                                <div class="pq-portfolio-img">
                                    <a href="#">
                                        <img src="/assets/frontend/images/portfolio/10.jpg" alt="">
                                    </a>
                                </div>
                                <div class="pq-portfolio-info">
                                    <div class="pq-portfolio-link">
    ...
    <div class="container">
        <div class="row align-items-center">
            <div class="col-xl-6 col-lg-6">
                <div class="pq-section pq-style-1 text-left">
                    <span class="pq-section-sub-title"># about us</span>
                    <h5 class="pq-section-title" id="development" data-high_text="Business" data-title_text="Product Devlopment For Better Business" data-rough_color="#fd4a18" data-rough_type="underline">Product Devlopment For Better Business</h5>
                    <p class="pq-section-description">There are many variations of passages of Lorem Ipsum available, but majority have suffered alteration in some form, by injected humour</p>
                </div>
                <ul class="pq-list-check">
                    <li class="pq-list-item">
                        <a href="#">
                            ...
                            <span>Lorem ipsum dolor sit amet, consectetur adipiscing elit ooking at its layout</span>
                        </a>
                    </li>
                    <li class="pq-list-item">
                        <a href="#">
                            <i class="ion ion-android-done-all"></i>
                            <span>Vestibulum blandit justo at felis dapibus varius more-or-less.</span>
                        </a>
                    </li>
                    <li class="pq-list-item">
                        <a href="#">
                            <i class="ion ion-android-done-all"></i>
                            <span>Nunc ut risus suscipit, egestas diam in, consequat odio use Lorem Ipsum.</span>
                        </a>
                    </li>
                    <li class="pq-list-item">
                        <a href="#">
                            <i class="ion ion-android-done-all"></i>
                            <span>Proin sed nunc consectetur, convallis risus nec, efficitur felis.</span>
                        </a>
                    </li>
                    <li class="pq-list-item">
                        <a href="#">
                    ...
                    <div class="rotate--circle">
                        <ul class="circle--rotate count6" id="circle--rotate">
                            <li class="block active">
                                <div class="icon"><i class="ion ion-android-desktop"></i></div>
                            </li>
                            <li class="block">
                                <div class="icon"><i class="ion ion-social-android"></i></div>
                            </li>
                            <li class="block">
                                <div class="icon"><i class="ion ion-social-apple"></i></div>
                            </li>
                            <li class="block">
                                <div class="icon"><i class="ion ion-android-cloud-done"></i></div>
                            </li>
                            <li class="block">
                                <div class="icon"><i class="ion ion-android-phone-portrait"></i></div>
                            </li>
                            <li class="block">
                        ...
                        <div class="animate-wrapper">
                            <div class="animate active">
                                <div class="animate-img">
                                    <div class="animate-img__in"
                                         style="background-image: url('images/round-slider/1.jpg');">
                            ...
                            <div class="animate">
                                <div class="animate-img">
                                    <div class="animate-img__in"
                                         style="background-image: url('images/round-slider/2.jpg');">
                                        <div class="animate-more">
                                            <div class="animate-title">
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <div class="pq-section pq-style-1 text-center">
                    <span class="pq-section-sub-title"># services</span>
                    <h5 class="pq-section-title pq-text-white" id="better" data-high_text="Business" data-title_text="Product Devlopment For Better Business" data-rough_color="#fd4a18" data-rough_type="underline">Product Devlopment For Better Business</h5>
                    <p class="pq-section-description pq-text-white">Lorem Ipsum is simply dummy It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout.</p>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="pq-section pq-style-1 text-center">
                    ...
                    <h5 class="pq-section-title" id="exclusive" data-high_text="Exclusive" data-title_text="Provide Exclusive Services" data-rough_color="#ffffff" data-rough_type="underline">Provide Exclusive Services</h5>
                </div>
            </div>
            <div class="col-lg-12">
                <div class="pq-tabs-1">
                    <div class="nav nav-tabs nav-fill" id="nav-tab" role="tablist"><a class="pq-tabs nav-item nav-link active"
                                                                                      id="nav-home-0" data-bs-toggle="tab" href="#nav-0" role="tab" aria-controls="nav-home-0" aria-selected="true">
                            <div class="pq-tabs-icon"><i class=" flaticon-marketing"></i><span>Mobile Development</span></div>
                        </a><a class="pq-tabs nav-item nav-link " id="nav-home-1" data-bs-toggle="tab" href="#nav-1" role="tab"
                        ...
                        </a><a class="pq-tabs nav-item nav-link " id="nav-home-2" data-bs-toggle="tab" href="#nav-2" role="tab"
                        ...
                        </a><a class="pq-tabs nav-item nav-link " id="nav-home-3" data-bs-toggle="tab" href="#nav-3" role="tab"
                    ...
                    <div class="tab-content text-left" id="nav-tabContent">
                        <div class="tab-pane fade show  active" id="nav-0" role="tabpanel" aria-labelledby="nav-home-0">
                            <div class="row align-items-center">
                                <div class="col-lg-6">
                                    <img src="/assets/frontend/images/tabs/1.jpg" alt="seo-image">
                                </div>
                                <div class="col-lg-6">
                        ...
                        <div class="tab-pane fade show" id="nav-1" role="tabpanel" aria-labelledby="nav-home-1">
                            <div class="row flex-row-reverse">
                                <div class="col-lg-6">
                                    <img src="/assets/frontend/images/tabs/2.jpg" alt="seo-image">
                                </div>
                        ...
                        <div class="tab-pane fade show  " id="nav-2" role="tabpanel" aria-labelledby="nav-home-2">
                            <div class="row">
                                <div class="col-lg-6">
                                    <img src="/assets/frontend/images/tabs/3.jpg" alt="seo-image">
                                </div>
                                <div class="col-lg-6 align-self-center">
                                    <div class="pq-tab-info">
                                        <h2>Cloud Hosting</h2>
                        ...
                        <div class="tab-pane fade show  " id="nav-3" role="tabpanel" aria-labelledby="nav-home-3">
                            <div class="row flex-row-reverse">
                                <div class="col-lg-6">
                                    <img src="/assets/frontend/images/tabs/4.jpg" alt="seo-image">
                                </div>
                                <div class="col-lg-6 align-self-center">
                                    <div class="pq-tab-info">
                                        <h2>Share Hosting</h2>
        ...
        <div class="row">
            <div class="col-xl-6 col-lg-6">
                <div class="pq-section pq-style-1 text-left">
                    ...
                    <h5 class="pq-section-title pq-text-white" id="your" data-high_text="Your" data-title_text="We Help You Grow Your Business Expntially" data-rough_color="#151515" data-rough_type="underline">We Help You Grow Your Business Expntially</h5>
                ...
                <div class="pq-progressbar-box pq-progressbar-style-1 ">
                    ...
                    <div class="pq-progressbar-content">
                        <span class="progress-title pq-text-white">It Support &amp; helpdesk</span>
                    ...
                    <div class="pq-progressbar-content">
                        <span class="progress-title pq-text-white">We Have an It Department</span>
            ...
            <div class="col-xl-6 col-lg-6 mt-4 mt-lg-0">
                <img src="/assets/frontend/images/benefits/1.jpg" alt="">
            </div>
        </div>
    </div>
</section>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="pq-section pq-style-1 text-center">
                    ...
                    <h5 class="pq-section-title" id="grow" data-high_text="Grow" data-title_text="We Help You Grow Your Business Expntially" data-rough_color="#ffffff" data-rough_type="underline">We Help You Grow Your Business Expntially</h5>
                </div>
            </div>
        </div>
        <div class="row justify-content-center">
            <div class="col-xl-4 col-lg-4 col-md-6">
                <div class="pq-process-step pq-process-2">
                    <img class="pq-before-img-1 d-none d-lg-block" src="/assets/frontend/images/arrow-1.png" alt="arrow-img">
                    ...
                    <div class="pq-process-info">
                        ...
                        <p class="pq-process-description">Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>
                    </div>
                </div>
            </div>
            <div class="col-xl-4 col-lg-4 col-md-6 mt-4 mt-md-0">
                <div class="pq-process-step pq-process-2">
                    <img class="pq-before-img-2 d-none d-lg-block" src="/assets/frontend/images/arrow-2.png" alt="arrow-img">
                    <div class="pq-process-icon">
                        <i class=" flaticon-marketing"></i>
    ...
    <div class="container">
        <div class="row pq-bg-primary align-items-center">
            <div class="col-xl-8 col-lg-8 col-md-8 pq-primary-section-side-left pq-p-90-30">
                <h5 class="pq-section-title pq-text-white" id="partner" data-high_text="Partner" data-title_text="We Create Real Impact For Those Who Partner With Us" data-rough_color="#ffffff" data-rough_type="underline">We Create Real Impact For Those Who Partner With Us</h5>
                <a href="contact-us.html" class="pq-button pq-btn-flat pq-mt-30 pq-button-dark">
                    <div class="pq-button-block">
                        <span class="pq-button-text">Contact Us</span>
                    </div>
                </a>
                <a href="about-us.html" class="pq-button pq-btn-flat pq-bg-white pq-mt-30 pq-ml-30">
                    <div class="pq-button-block">
            ...
            <div class="col-xl-4 col-lg-4 col-md-4 mt-4 mt-md-0 pe-xl-5">
                <img src="/assets/frontend/images/1.png" class="pq-img-overflow" alt="">
            </div>
        </div>
    </div>
</section>
        ...
        <div class="row justify-content-center">
            <div class="col-lg-12">
                <div class="pq-section pq-style-1 text-center">
                    ...
                    <h5 class="pq-section-title" id="plan" data-high_text="Plan" data-title_text="Choose Our Plan" data-rough_color="#fd4a18" data-rough_type="underline">Choose Our Plan</h5>
                ...
                <div class=" pq-pricebox pq-pricebox-1 text-center">
                    <div class="pq-price-detail">
                        ...
                        <div class="pq-bg-effect">
                            <img src="/assets/frontend/images/pricing-plan/1.png" alt="gym-image">
                        </div>
                    </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-xl-3 col-md-6">
                        <div class="widget">
                            <img src="/assets/frontend/images/logos/footer-logo.png" class="pq-footer-logo" alt="gym-footer-logo">
                    ...
                    <div class="col-xl-3  col-md-6">
                        <div class="pq-widget-menu widget">
                            ...
                            <div class="pq-footer-recent-post">
                                <div class="pq-footer-recent-post-media">
                                    <a href="app-promotes-sales-profits-in-it-solutions.html">
                                        <img src="/assets/frontend/images/footer-blog/1.jpg" alt="">
                                    </a>
                                </div>
                            ...
                            <div class="pq-footer-recent-post">
                                <div class="pq-footer-recent-post-media">
                                    <a href="app-promotes-sales-profits-in-it-solutions.html">
                                        <img src="/assets/frontend/images/footer-blog/2.jpg" alt="">
                                    </a>
                                </div>
                                <div class="pq-footer-recent-post-info">
...
<!--Custom js-->
<script src="/assets/frontend/js/rough-script.js"></script>
<script src="/assets/frontend/js/rough-notation.iife.js"></script>
<script src="/assets/frontend/js/rough-custom.js"></script>
